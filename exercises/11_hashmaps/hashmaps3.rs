...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        // }
        // else {
        //     let current_scores = scores.get(team_1_name).unwrap();
        //     scores.insert(team_1_name, TeamScores {goals_scored: current_scores.goals_scored + team_1_score, goals_conceded: current_scores.goals_conceded + team_2_score});
        // }
        ...
        // }
        // else {
        //     let current_scores = scores.get(team_2_name).unwrap();
        //     scores.insert(team_2_name, TeamScores {goals_scored: current_scores.goals_scored + team_2_score, goals_conceded: current_scores.goals_conceded + team_1_score});
        // }
